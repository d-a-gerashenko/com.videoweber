...
namespace Extensions\AvalancheImagineBundle\Controller;
...
class ImagineController
{
    ...
    public function filter($path, $filter)
    {
        ...
        try {
            /***********************************************************************/
            /*
             * И здесь решаем проблему выдачи jpg файлов как png, при первом создании кеша.
             */
            /***********************************************************************/
            $format  = $this->filterManager->getOption($filter, "format", $extension);
