package com.videoweber.client.window.channel_archive;
...
import com.videoweber.client.service.channel_track_service.ChannelTrack;
import com.videoweber.client.service.channel_track_service.ChannelTrackService;
...
public class ChannelArchiveController extends WindowController {
                    ...
                    if (renderingMin != null) {
                        ...
                        repository.findByRange(
                            ...
                            if (se.isLoaded()) {
                                ...
                                if (se.isRecorded()) {
                                    lastCanvas.getGraphicsContext2D().setFill(Color.web("#ffb2b2"));
                                } else {
                                    lastCanvas.getGraphicsContext2D().setFill(Color.web("#eaeaea"));
                                }
    ...
    public void onWindowOpened(Object[] parameters) {
        ...
        ChannelTrack channelTrack = getService(ChannelTrackService.class).createChannelTrack(detachedChannelEntity);
