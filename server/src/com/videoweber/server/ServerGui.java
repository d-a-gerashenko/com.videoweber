...
public class ServerGui extends Gui {
    ...
    private final String TITLE = "Сервер видеонаблюдения";
    ...
    public void onAppStart(Stage primaryStage) {
        ...
        scene.getStylesheets().add(ResourceManager.getResourceFile("com/videoweber/server/splash_screen.css").toURI().toString());
